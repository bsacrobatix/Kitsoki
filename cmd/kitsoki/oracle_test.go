// oracle_test.go — tests for `kitsoki oracle <verb>` subcommands (Phase 6).
//
...
func TestOracleExtract_BuildsArgsMap(t *testing.T) {
	t.Parallel()
...
func TestOracleExtract_WithResolversYAML(t *testing.T) {
	t.Parallel()
...
func TestOracleExtract_NoResolversYAML_AgentInRoot(t *testing.T) {
	t.Parallel()
...
func TestOracleExtract_ParentSessionPropagated(t *testing.T) {
	t.Parallel()
...
func TestOracleExtract_DispatchesHandler(t *testing.T) {
	t.Parallel()
	...
	res, err := dispatchOracleRPC(ctx, "oracle.extract", map[string]any{
		"input":  "go north",
...
func TestOracleDecide_BuildsArgsMap(t *testing.T) {
	t.Parallel()
...
func TestOracleDecide_InvalidArgsJSON(t *testing.T) {
	t.Parallel()
...
func TestOracleDecide_ValidatorCmd(t *testing.T) {
	t.Parallel()
...
func TestOracleDecide_MissingSchemaReturnsError(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), host.FakeDecide(""))
	res, err := dispatchOracleRPC(ctx, "oracle.decide", map[string]any{}, nil)
	if err != nil {
		t.Fatalf("dispatch should not return infra error: %v", err)
	}
	if res.Error == "" {
...
func TestOracleAsk_BuildsArgsMap(t *testing.T) {
	t.Parallel()
...
func TestOracleAsk_NoSchemaOmitsSchemaKey(t *testing.T) {
	t.Parallel()
...
func TestOracleAsk_MissingPromptReturnsError(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), host.FakeAsk(""))
	res, err := dispatchOracleRPC(ctx, "oracle.ask", map[string]any{}, nil)
	if err != nil {
		t.Fatalf("dispatch should not return infra error: %v", err)
	}
	if res.Error == "" {
...
func TestOracleTask_BuildsArgsMap(t *testing.T) {
	t.Parallel()
...
func TestOracleTask_NoAcceptanceCmdOmitsPostCmd(t *testing.T) {
	t.Parallel()
...
func TestOracleTask_MissingAgentReturnsError(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), host.FakeTask(""))
	res, err := dispatchOracleRPC(ctx, "oracle.task", map[string]any{}, nil)
	if err != nil {
		t.Fatalf("dispatch should not return infra error: %v", err)
	}
	if res.Error == "" {
...
func TestOracleConverse_MissingQuestionReturnsError(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), host.FakeConverse(""))
	res, err := dispatchOracleRPC(ctx, "oracle.converse", map[string]any{}, nil)
	if err != nil {
		t.Fatalf("dispatch should not return infra error: %v", err)
	}
	if res.Error == "" {
...
func TestDispatchOracleRPC_UnknownMethod(t *testing.T) {
	t.Parallel()
	ctx := context.Background()
	_, err := dispatchOracleRPC(ctx, "oracle.nonexistent", nil, nil)
	if err == nil {
...
func TestDispatchOracleRPC_NilParamsOK(t *testing.T) {
	t.Parallel()
	ctx := host.WithClaudeRunner(context.Background(), host.FakeDecide(""))
	// nil params should not panic — treated as empty map.
	res, err := dispatchOracleRPC(ctx, "oracle.decide", nil, nil)
	if err != nil {
...
func TestWriteOracleResult_JSON(t *testing.T) {
	t.Parallel()
	res := host.Result{
		Data: map[string]any{
	...
	if err := writeOracleResult(&buf, res); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestWriteOracleResult_ErrorSurfaces(t *testing.T) {
	t.Parallel()
	res := host.Result{Error: "something went wrong"}
	var buf bytes.Buffer
	err := writeOracleResult(&buf, res)
	if err == nil {
...
func TestWriteOracleResult_EmptyDataOK(t *testing.T) {
	t.Parallel()
...
func TestInjectSessionID_InheritsFromEnv(t *testing.T) {
	...
	t.Setenv(oracleSessionIDEnv, "from-env-456")
...
func TestInjectSessionID_DoesNotMutateGlobalEnv(t *testing.T) {
	t.Parallel()
	prev := os.Getenv(oracleSessionIDEnv)
	_ = injectSessionID(context.Background(), "new-sid-999")
	got := os.Getenv(oracleSessionIDEnv)
	if got != prev {
