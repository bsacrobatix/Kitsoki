...
providers; a downstream devstory flavour (Phase 7) for Jira /
Bitbucket / Jenkins.
...
A downstream Jira-backed flavour rebinds `iface.ticket` to
`host.jira`; kitsoki-dev rebinds to `host.local_files.ticket`. Same
YAML, two providers.
