...
if profile_path.exists():
    ...
    check("valid story pack", "story_pack: \"focused-engineering\"" in profile_text)
    check("valid story pack title", "story_pack_title: \"Focused engineering starter\"" in profile_text)
...
if readme_path.exists():
    ...
    check("valid readme starter pack", "Starter story pack: `focused-engineering`" in readme_text)
