...
if profile_path.exists():
    ...
    check("valid story pack", "story_pack: \"cyber-repo\"" in profile_text)
    check("valid story pack title", "story_pack_title: \"Cyber repo starter\"" in profile_text)
...
if readme_path.exists():
    ...
    check("valid readme starter pack", "Starter story pack: `cyber-repo`" in readme_text)
