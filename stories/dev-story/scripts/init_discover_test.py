...
check("go story pack", prof["story_pack"], "focused-engineering")
check("go story pack title", prof["story_pack_title"], "Focused engineering starter")
...
check("story pack default", mod.parse_story_pack(""), "focused-engineering")
...
check("missing target story pack", prof["story_pack"], "focused-engineering")
