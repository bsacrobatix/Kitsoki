...
//     on their last stdout line be bound directly into
//     a world slot via `bind: <slot>: stdout_json`.
//     Mirrors the same field exposed by
...
func RegisterBuiltins(r *Registry) {
	...
	// host.<name>.<op> call to the longest registered prefix).
