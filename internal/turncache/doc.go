...
//
// The package is the storage abstraction for §2.2 and §7 of the
// semantic-routing proposal (docs/proposals/semantic-routing-proposal.md).
// Phase 5 ships an in-memory implementation behind the [Cache] interface;
// Phase 6 will add a SQLite backend behind the same interface, so the
// interface here is load-bearing.
//
