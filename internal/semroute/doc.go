// Package semroute implements the semantic-routing tier (§2.1 / §10
// Phase 2 + Phase 4 of docs/proposals/semantic-routing-proposal.md).
// It sits in the orchestrator between
