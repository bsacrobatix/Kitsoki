...
//
// This logic lives in its own leaf package (no kitsoki deps) so both the oracle
...
// import cycle: oracle already imports app, so app cannot import oracle. The
// oracle package re-exports SubsetOK as oracle.GrammarSubsetOK to keep its
