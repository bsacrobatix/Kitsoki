...
def build_kitsoki_prompt(
    ...
    return "\n".join([
        ...
        "   Then run this exact control loop: after EVERY settled turn call",
        "   session.status; if `running` is present, poll status until it clears; if",
        ...
        "4. STOP only at a terminal state, ~25 forward turns, or a repeated stuck state. If a",
