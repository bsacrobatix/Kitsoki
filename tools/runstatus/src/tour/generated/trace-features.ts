...
export const TRACE_TOUR_STEPS: readonly TourStep[] = [
  ...
  },
  {
    ...
    route: "interactive",
    target: "back-stories",
    title: "Back to the story library",
    body: "The trace tools live in the read-only observer view — built for inspecting a run while it's live or after it's finished. Head back to the story library to open this run there.",
    placement: "bottom",
    kind: "action",
    advance: "route-match",
    advanceRoute: "home",
  ...
  },
  {
    ...
    route: "home",
    target: "session-open",
    title: "Open the run in the observer",
    body: "This run is now listed as active. Open it to switch into the read-only observer and introspect it.",
    placement: "left",
    kind: "action",
    advance: "route-match",
    advanceRoute: "any",
    waitForTarget: "session-open",
    dwellMs: 4000,
  },
  {
    id: "trace-welcome",
