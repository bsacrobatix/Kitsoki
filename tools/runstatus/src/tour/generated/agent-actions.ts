...
export const AGENT_ACTIONS_TOUR_STEPS: readonly TourStep[] = [
  ...
  },
  {
    ...
    body: "The agent-action transcripts live in the read-only observer view, where every recorded call can be inspected and replayed. Head back to the story library to open this run there.",
    placement: "bottom",
    kind: "action",
    advance: "route-match",
    advanceRoute: "home",
  ...
  },
  {
    ...
    body: "This run is now listed as active. Open it to switch into the read-only observer.",
    placement: "left",
    kind: "action",
    advance: "route-match",
    advanceRoute: "any",
