...
export const TOUR_STEPS: readonly TourStep[] = [
  ...
  },
  {
    ...
    body: "Head back to the story library anytime — your run keeps going and stays listed there as an active session.",
    placement: "bottom",
    kind: "action",
    advance: "route-match",
    advanceRoute: "home",
  },
  {
    ...
    target: "session-open",
    title: "Observe mode",
    body: "Open an active session from the list to get the read-only observer view — handy for watching an LLM-driven run, or reviewing a finished one.",
    placement: "left",
    kind: "action",
    advance: "route-match",
    advanceRoute: "any",
