...
```sh
python3 aggregate.py --generated-at <iso> --emit-agenteval
python3 ../session-mining/eval_pilot_report.py --markdown --deck
...
and `results/cells/*.json` for data; the deck regenerates with **no LLM calls**.
