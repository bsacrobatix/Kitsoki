...
| `host_interfaces:` + cascading `host_bindings:` (`internal/app/imports_interfaces.go:42-102`; `stories/bugfix/app.yaml:141-196`) | capability contracts with swappable glue providers (cf. [`gh-ticket-adapter.md`](gh-ticket-adapter.md)) | shipped (shapes unchecked) |
